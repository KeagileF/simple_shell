...
/**
 * get_history_file - A func use in retrieving file history
...
/**
 * write_history - A funcc used to create a file,
...
/**
 * read_history -A func that assits in reading
...
/**
 * build_history_list - A fun used to add entry
...
/**
 * renumber_history -  A func used to renumber
