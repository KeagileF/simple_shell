...
/**
 * print_error - A func that prints an error message
...
/**
 * print_d - A function to print a decimal
...
int print_d(int input, int fd)
{
	...
	_abs_ = (input < 0) ? (__putchar('-'), count++, -input) : input;
...
/**
 * remove_comments - A function that replaces first
 * instance of '#' with '\0'
