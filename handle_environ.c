...
/**
 * _myenv - A function that  prints the current
...
/**
 * _mysetenv - A function used to modify or initialize
...
/**
 * _myunsetenv - A function used to remove an environment variable
