...
/**
 * list_to_strings - array of strings of the list->str are returned
...
/**
 * node_starts_with - node whose string starts with prefix are returned
...
/**
 * get_node_index - index of a node is derived
